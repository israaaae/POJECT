...
def test_rag_pipeline(mocker):
    ...
    mock_vector_store.return_value.fct_query.return_value = [{"metadata": {"text": "Paris is the capital of France"}}]
    ...
    mock_vector_store.return_value.fct_query.assert_called_once()
